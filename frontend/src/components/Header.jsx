        ...
        <div className="flex justify-between items-center text-black bg-[#F5F5DC] shadow-xl py-3 pr-[7vw] pl-[6vw]">
          ...
          >
            <img
              src={logo2}
              alt=""
              className="xl:w-[206px] xl:h-[100px] h-15"
            />
          </a>
          ...
          <a
            href="#"
            className="hidden xl:flex justify-between items-center text-2xl font-bold gap-2"
          >
          ...
          >
            <span
              className={`block w-6 h-1 bg-gray-700 rounded transition-all ${
                open ? "rotate-45 translate-y-2 z-50" : ""
              }`}
            ></span>
            <span
              className={`block w-6 h-1 bg-gray-700 rounded my-1 transition-all ${
                open ? "opacity-0 z-50" : ""
              }`}
            ></span>
            <span
          ...
          <div
            className={`fixed top-0 right-0 h-full w-64 bg-[#F5F5DC] text-black p-5 transform ${
          ...
          >
            ...
            <ul className="mt-18 space-y-10 pr-2">
              <a
                href="#"
                className="flex justify-start items-center text-{12px} gap-7 font-bold ml-1"
              >
              ...
              <a
                href="#"
                className="flex justify-start items-center text-{12px} gap-6 font-bold ml-1"
              >
              ...
              <a
                href="#"
                className="flex justify-start items-center text-{12px} gap-6 font-bold ml-2"
              >
              ...
              <a
                href="#"
                className="flex justify-start items-center text-{12px} gap-7 font-bold ml-2"
              >
              ...
              <a
                href="#"
                className="flex justify-start items-center text-{12px} gap-6.5 font-bold ml-2"
              >
