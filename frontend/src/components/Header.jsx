    ...
    <div className="">
      <div className='flex justify-between items-center text-black bg-[#F5F5DC] shadow-xl py-3 pr-[7vw] pl-[6vw]'>
        <Link to="/" className="flex justify-between items-center text-2xl font-bold gap-3 mt-2">
          <img src={logo} alt="Logo" className="w-[206px] h-[84px]" />
        </Link>
        <div className='flex justify-between items-center gap-[2.8vw]'>
          ...
          <Link to="/shop" className="flex justify-between items-center text-2xl font-bold gap-2">
            <img src={shop} alt="Shop" className="w-11" />
            <p>Shop</p>
          </Link>
          <a href="#" className='flex justify-between items-center text-2xl font-bold gap-3'>
