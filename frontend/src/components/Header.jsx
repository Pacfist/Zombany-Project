    ...
    <div className="">
      ...
      >
        ...
        <ul className="mt-18 space-y-10 pr-2">
          ...
          <a href="#" className='flex justify-start items-center text-{12px} gap-6 font-bold ml-1'>
            <img src={camera} alt="" className='w-9'/>
            <p>Take a shot</p>
          </a>
          <a href="#" className='flex justify-start items-center text-{12px} gap-6 font-bold ml-2'>
          ...
          <a href="#" className='flex justify-start items-center text-{12px} gap-6.5 font-bold ml-2'>
